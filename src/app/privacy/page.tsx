    ...
    <div className="flex-1 py-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full space-y-12 font-sans">
      ...
      <section className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <div className="p-4 bg-card text-card-foreground border border-border shadow-sm rounded-xl space-y-2">
            <EyeOff className="h-5 w-5 text-emerald-400" />
            <h3 className="text-xs font-bold text-foreground">Zero Retention</h3>
          ...
          <div className="p-4 bg-card text-card-foreground border border-border shadow-sm rounded-xl space-y-2">
            ...
            <h3 className="text-xs font-bold text-foreground">No Model Training</h3>
            <p className="text-[11px] text-muted-foreground leading-normal">
          ...
          <div className="p-4 bg-card text-card-foreground border border-border shadow-sm rounded-xl space-y-2">
            ...
            <h3 className="text-xs font-bold text-foreground">Strict Encryption</h3>
            <p className="text-[11px] text-muted-foreground leading-normal">
