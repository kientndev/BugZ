          ...
          <div className="flex-1 flex flex-col space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <h2 className="text-xs font-semibold text-foreground">Source Code Input</h2>
              </div>
              <div className="flex space-x-2">
                <button 
                  onClick={() => loadSample('sqlInjection')}
                  className="text-[10px] px-2 py-0.5 rounded bg-muted hover:bg-muted/80 border border-border text-muted-foreground hover:text-foreground font-medium cursor-pointer transition"
                >
                  SQL Injection
                </button>
                <button 
